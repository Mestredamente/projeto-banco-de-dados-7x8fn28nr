    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 mt-1">Gerencie a base de pacientes e convites.</p>
        </div>
        <div className="space-x-3">
          <Button variant="outline" asChild className="hidden sm:inline-flex">
            <Link to="/patients/new">Adicionar Manualmente</Link>
          </Button>
          <Button
            className="bg-teal-600 hover:bg-teal-700 text-white"
            onClick={() => setInviteModalOpen(true)}
          >
            <UserPlus className="mr-2 h-4 w-4" /> Convidar Paciente
          </Button>
        </div>
      </div>
      ...
      <Tabs defaultValue="list">
        <TabsList className="mb-4">
          <TabsTrigger value="list">Pacientes Cadastrados</TabsTrigger>
